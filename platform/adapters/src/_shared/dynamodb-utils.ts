 ...
 *
 * @returns The core table name (e.g., "fedbounty-core-dev")
 ...
 *
 * @returns The base table name (e.g., "fedbounty-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "fedbounty-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "fedbounty-app-realtime-dev")
